...
public class TestOfficial {
    ...
    static void test17() {
        ...
        if (fibonacciHeap.potential() != 1 ||
        	...
        	System.out.println("pot: " + fibonacciHeap.potential());
            System.out.println("cuts1: " + cuts);
            System.out.println("cuts2: " + FibonacciHeap.totalCuts());
            System.out.println("links1: " + links);
            System.out.println("links2: " + FibonacciHeap.totalLinks());
            bugFound(test);
        }
    }
    ...
    static void test18() {
        ...
        if (fibonacciHeap.potential() != 1 ||
            ...
            System.out.println("countersRep: " + Arrays.toString(fibonacciHeap.countersRep()));
            bugFound(test);
        }
    }
    ...
    static void test22() {
        ...
        if (fibonacciHeap.potential() != treeSize || // XX
